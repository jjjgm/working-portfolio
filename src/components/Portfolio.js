    ...
    return (
        <div className="portfolio-grid">
            ...
            <figure>
                {/* image */ }
                <caption>
                    <a href="https://joshd50.github.io/jenhua-joerdo/">
                        <h3>Stylist.Ai</h3>
                    </a>
                </caption>
                <p className="figure-text">
                    ...
                    <br />(NOTE: Currently not fetching API requests from OpenAI & GoogleScrape - trial credits were used for academic purposes)
                    <br />
                    <br />
                    Tools & Technologies:
                    <br />
